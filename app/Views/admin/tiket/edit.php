...
<div class="form-wrapper">
    <h2>Edit Tiket</h2>
    <form action="/admin/tiket/update/<?= $tiket['id'] ?>" method="post">
        <label>Nama Laga:</label>
        <input type="text" name="nama_laga" value="<?= $tiket['nama_laga'] ?>" required>

        <label>Tanggal:</label>
        <input type="date" name="tanggal" value="<?= $tiket['tanggal'] ?>" required>

        <label>Lokasi:</label>
        <input type="text" name="lokasi" value="<?= $tiket['lokasi'] ?>" required>

        <label>Harga:</label>
        <input type="number" name="harga" value="<?= $tiket['harga'] ?>" required>

        <label for="stok">Stok</label>
        <input type="number" name="stok" id="stok" value="<?= $tiket['stok'] ?>" required>
